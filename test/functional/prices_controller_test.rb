...
class PricesControllerTest < ActionController::TestCase
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post :create, price: { active: @price.active, position: @price.position, price: @price.price, product_id: @price.product_id }
    end
  ...
  test "should update price" do
    put :update, id: @price, price: { active: @price.active, position: @price.position, price: @price.price, product_id: @price.product_id }
    assert_redirected_to price_path(assigns(:price))
  end
