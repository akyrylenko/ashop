...
class ProductTypesControllerTest < ActionController::TestCase
  ...
  test "should create product_type" do
    assert_difference('ProductType.count') do
      post :create, product_type: { name: @product_type.name, parent_id: @product_type.parent_id, position: @product_type.position }
    end
  ...
  test "should update product_type" do
    put :update, id: @product_type, product_type: { name: @product_type.name, parent_id: @product_type.parent_id, position: @product_type.position }
    assert_redirected_to product_type_path(assigns(:product_type))
  end
